...
import { Navigation, Minimize2, Maximize2, X, Clock, Calendar, Eye, Leaf, Droplets, MapPin, Layers, Search, Home, LogOut, Map, Plus, Satellite, Zap } from "lucide-react"
...
// Importar el nuevo PhotoAnalyzer modal
...
const MapComponent: React.FC<{ onAnalyze?: (data: any) => void }> = ({ onAnalyze }) => {
  ...
  // Lógica de habilitación para botones - ahora requiere polígono dibujado
          ...
          {!isActionEnabled && (
            <div className="text-center p-6 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Usa las herramientas de dibujo en el mapa para crear un polígono
              </p>
            </div>
          )}
